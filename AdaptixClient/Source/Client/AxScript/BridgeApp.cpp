...
QString BridgeApp::donut_generate(const QString &file, const QString &params, const QString &arch, const QString &payload_type)
{
    ...
    c.exit_opt  = DONUT_OPT_EXIT_PROCESS; // Exit process when done (prevents hangs)
...
// x64 Pipe Redirect Stub - connects to named pipe and redirects stdout/stderr
// Pipe name placeholder starts at offset 359 (\\.\pipe\dnt_)
static const unsigned char PIPE_REDIRECT_STUB_X64[] = {
    
};
static const int PIPE_REDIRECT_STUB_X64_LEN = 388;
static const int PIPE_NAME_OFFSET_X64 = 355;  // Offset of "\\.\pipe\dnt_" in stub (verified)

QString BridgeApp::donut_generate_with_pipe(const QString &file, const QString &params, const QString &arch, const QString &pipeName)
{
    // First generate normal Donut shellcode
    QString resolvedFile = file;
    if (resolvedFile.startsWith("~/"))
        resolvedFile = QDir::home().filePath(resolvedFile.mid(2));
    ...
    // Only x64 for now (stub is x64)
    c.arch = DONUT_ARCH_X64;

    QByteArray fileBytes = resolvedFile.toUtf8();
    if (fileBytes.size() >= DONUT_MAX_NAME) {
         Q_EMIT engineError("donut_generate_with_pipe: File path too long");
         return "";
    }
    strncpy(c.input, fileBytes.constData(), DONUT_MAX_NAME - 1);
    ...
    if (!params.isEmpty()) {
        QByteArray paramBytes = params.toUtf8();
        if (paramBytes.size() >= DONUT_MAX_NAME) {
            Q_EMIT engineError("donut_generate_with_pipe: Params too long");
            return "";
        }
        strncpy(c.args, paramBytes.constData(), DONUT_MAX_NAME - 1);
    }
    ...
    int err = DonutCreate(&c);
    if (err != DONUT_ERROR_OK) {
        Q_EMIT engineError("donut_generate_with_pipe failed: " + QString(DonutError(err)));
        return "";
    }

    // Create combined shellcode: stub + donut
    QByteArray stub((const char*)PIPE_REDIRECT_STUB_X64, PIPE_REDIRECT_STUB_X64_LEN);
    ...
    // Copy pipe name into stub at the offset (overwrite the placeholder)
    for (int i = 0; i < pipeNameBytes.size() && (PIPE_NAME_OFFSET_X64 + i) < stub.size(); i++) {
        stub[PIPE_NAME_OFFSET_X64 + i] = pipeNameBytes[i];
    }
    
    // Append Donut shellcode

...
void DialogSubscriptions::createUI()
{
    ...
    historyListWidget->addItem(makeSectionHeader("数据"));
    ...
    historyListWidget->addItem(makeSectionHeader("代理"));
    ...
    realtimeListWidget->addItem(makeSectionHeader("数据"));
    ...
    realtimeListWidget->addItem(makeSectionHeader("代理"));
    ...
    consoleTeammodeCheck = new QCheckBox("控制台团队模式", this);
    consoleTeammodeCheck->setChecked(true);
    consoleTeammodeCheck->setToolTip("查看所有操作员的控制台输出");

    agentsOnlyActiveCheck = new QCheckBox("仅活跃代理", this);
    agentsOnlyActiveCheck->setToolTip("仅同步活跃代理");
    agentsOnlyActiveCheck->setEnabled(false);

    tasksOnlyJobsCheck = new QCheckBox("仅作业任务", this);
    tasksOnlyJobsCheck->setToolTip("仅同步作业");
    tasksOnlyJobsCheck->setEnabled(false);

    syncInactiveAgentsButton = new QPushButton("同步非活跃代理", this);

...
func (m *ModuleExtender) AgentTunnelTaskSock5(desc string, lhost string, lport int, auth bool, username string, password string, agentData adaptix.AgentData) (adaptix.TaskData, error) {
	var err error
	taskData := adaptix.TaskData{}

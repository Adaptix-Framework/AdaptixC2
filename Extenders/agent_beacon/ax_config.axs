...
function RegisterCommands(listenerType)
{
    ...
    var cmd_powershell = ax.create_command("powershell", "Execute command via powershell.exe", "powershell ls");
    ...
    var cmd_interact = ax.create_command("interact", "Set 'sleep 0'", "interact");

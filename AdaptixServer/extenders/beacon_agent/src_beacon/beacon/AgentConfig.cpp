...
AgentConfig::AgentConfig()
{
	...
	this->profile.doh_resolvers = packer->UnpackBytesCopy(&length);  // DoH resolver URLs
	...
	this->profile.dns_mode      = packer->Unpack32();  // DNS mode (0=UDP, 1=DoH, 2=UDP->DoH, 3=DoH->UDP)

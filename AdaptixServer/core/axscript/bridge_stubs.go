...
func newStubWidget(rt *goja.Runtime) *goja.Object {
	...
	obj.Set("removeItem", func(goja.FunctionCall) goja.Value { return goja.Undefined() })
...
func registerFormStubs(engine *ScriptEngine) {
	...
	formObj.Set("create_switch", func(call goja.FunctionCall) goja.Value { return newStubWidget(rt) })
	formObj.Set("create_segcontrol", func(call goja.FunctionCall) goja.Value { return newStubWidget(rt) })
